...
public class Menu {
	...
	public Menu(String file_path) {
		...
		if (result) {
			...
			this.statistics = election.statistics;
			this.setup_flag = 1;	 
			System.out.println("Successfully setup election.");
		}else {
			System.out.println("Setup election failed. Please check your selected file.");
		}	
	}
